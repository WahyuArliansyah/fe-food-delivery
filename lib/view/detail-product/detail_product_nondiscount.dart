...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  // Fungsi untuk menambahkan jumlah makanan
  void plusMakanan() {
    setState(() {
      jumlahMakanan++;
    });
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
              "Apakah anda yakin ingin memesan ${jumlahMakanan} ${widget.product['nama']}?"),
          actions: [
            TextButton(
              onPressed: () {
            ...
            TextButton(
              onPressed: () async {
                ...
                if (context.mounted) {
                  ...
                  if (context.mounted) {
                    Navigator.of(context).push(_createRoute(widget.product));
                  }
                }
              },
              child: const Text(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text(widget.product['jarak']),
                        const SizedBox(width: 16),
                        const Icon(Icons.timer, color: Colors.grey),
                        const SizedBox(width: 4),
                        Text(widget.product['waktu']),
                      ],
                    ),
                    const SizedBox(height: 8),
                    Container(
